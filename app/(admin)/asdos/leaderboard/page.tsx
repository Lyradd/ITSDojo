...
export default function AsdosLeaderboardPage() {
      ...
      <div className="mb-8">
        <div className="flex items-center justify-between gap-3 mb-2">
          <div className="flex items-center gap-3">
            <div className="p-3 bg-emerald-500/10 rounded-2xl border-2 border-emerald-500/20 shadow-xl shadow-emerald-500/5">
            ...
            <div>
              ...
              <div className="flex items-center gap-2 text-zinc-500 dark:text-zinc-400 font-bold text-sm">
                <span>ITSDojo Asisten Dosen</span>
                {isConnected && (
      ...
      <div className="grid grid-cols-1 lg:grid-cols-[1fr_300px] gap-6">
        ...
        <div className="min-w-0">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8">
            <Card className="p-5 rounded-3xl border-none bg-linear-to-br from-emerald-500 to-teal-600 shadow-xl shadow-emerald-500/20 group hover:-translate-y-1 transition-all duration-300">
              ...
              <div className="text-[10px] text-emerald-100 font-black mt-2 uppercase tracking-widest">
                Mahasiswa Aktif
              </div>
            </Card>
          ...
          <div className="mb-6">
            ...
            <div className="flex items-center gap-3">
              ...
              <select 
                className="flex-1 max-w-[240px] px-3 py-1.5 text-[13px] rounded-lg border border-zinc-200 dark:border-zinc-700 bg-white dark:bg-zinc-900 text-zinc-900 dark:text-zinc-100 outline-none hover:border-zinc-400 focus:border-emerald-500 transition-colors"
                value={subScope}
          ...
          <Card className="bg-white dark:bg-zinc-900 border-2 border-zinc-200 dark:border-zinc-800 rounded-3xl overflow-hidden shadow-xl shadow-zinc-200/50 dark:shadow-none">
            <div className="px-6 py-4 bg-zinc-50/80 dark:bg-zinc-900/80 border-b border-zinc-200 dark:border-zinc-800 flex items-center gap-2 text-[14px] font-bold text-zinc-900 dark:text-zinc-100">
              <List className="w-4 h-4 text-emerald-600 dark:text-emerald-400" /> Peringkat Mahasiswa
            </div>
        ...
        <div className="flex flex-col gap-6">
          ...
          {/* Quick Actions Card */}
          <Card className="bg-white dark:bg-zinc-900 border-2 border-emerald-200 dark:border-emerald-800/50 rounded-3xl p-6 shadow-xl shadow-emerald-100/50 dark:shadow-none hover:border-emerald-400 dark:hover:border-emerald-700 transition-colors">
            <h3 className="text-[16px] font-bold text-emerald-900 dark:text-emerald-100 mb-5 flex items-center gap-2">
              <Eye className="w-4 h-4" /> Monitoring
            </h3>
            
            <div className="space-y-3">
              <button 
                className="w-full p-3 bg-emerald-600 hover:bg-emerald-700 text-white rounded-xl text-[14px] font-bold flex items-center justify-center gap-2 transition-all shadow-md shadow-emerald-600/20 hover:shadow-emerald-600/40 hover:-translate-y-0.5"
              >
