...
export default function DosenMorePage() {
  ...
  const features = [
    ...
    },
    {
      ...
      description: "Lihat peringkat kelas",
      href: "/dosen/leaderboard",
    ...
    },
    {
      icon: Settings,
      title: "Pengaturan",
      description: "Pengaturan akun dosen",
      href: "/dosen/settings",
        ...
        <div className="flex items-center gap-4">
          ...
          <div className="flex-1">
            ...
            <p className="text-xs text-zinc-500 dark:text-zinc-500 mt-1 capitalize">
              {role === "dosen" ? "Dosen" : "Asisten Dosen"}
            </p>
          </div>
        </div>
      </Card>
