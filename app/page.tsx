...
export default function LandingPage() {
  ...
  return (
    <div ref={containerRef} className="flex flex-col min-h-screen bg-[#050505] text-zinc-100 selection:bg-blue-500/30 font-sans relative overflow-x-hidden cursor-none">
      <CustomCursor />
