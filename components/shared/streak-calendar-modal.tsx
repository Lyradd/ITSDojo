                ...
                {days.map(day => {
                  ...
                  return (
                    <div 
                      ...
                      className={`aspect-square rounded-md sm:rounded-lg flex flex-col items-center justify-center relative group transition-all ${
                        active 
                          ...
                          : freeze
                            ? 'border sm:border-2 border-cyan-500/50 bg-cyan-500/20 text-cyan-500 dark:border-cyan-500/40 dark:bg-cyan-500/10 dark:text-cyan-400 shadow-[0_0_10px_rgba(6,182,212,0.2)]'
                            : today 
                    ...
                    >
                      ...
                      {freeze && <Snowflake className="w-2.5 h-2.5 absolute bottom-1 text-cyan-500 dark:text-cyan-400" />}
