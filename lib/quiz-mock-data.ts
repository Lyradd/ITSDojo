...
export type BloomLevel = 'C1' | 'C2' | 'C3' | 'C4' | 'C5' |export interface Question {
  id: string;
  questionText: string;
...
export const MOCK_WEB_DEV_QUESTIONS: Question[] = [
  {
    id: 'wd1',
    questionText: 'Apa fungsi dari HTML dalam pengembangan web?',
    questionType: 'multiple_choice',
    options: [
    ...
    correctAnswer: 'Menentukan struktur halaman',
    points: ,
    timeLimit: 30,
    order: 1,
  },
  {
    id: 'wd2',
    questionText: 'CSS digunakan untuk memformat tampilan halaman web.',
    questionType: 'true_false',
    options: ['True', 'False'],
    correctAnswer: 'True',
    points: ,
  ...
  {
    id: 'wd3',
    questionText: 'Jelaskan perbedaan antara `id` dan `class` di CSS.',
    questionType: 'short_answer',
    correctAnswer: 'id unik class dapat berulang',
    points: ,
    timeLimit: 45,
    order: 3,
  },
  {
    id: 'wd4',
    questionText: 'Tuliskan snippet JavaScript untuk mengambil elemen dengan id "app".',
    questionType: 'short_answer',
    correctAnswer: 'document.getElementById("app")',
    points: ,
    timeLimit: 60,
    order: 4,
  },
  {
    id: 'wd5',
    questionText: 'Apa output dari `console.log(typeof null)` di JavaScript?',
    questionType: 'multiple_choice',
  ...
  {
    id: 'wd6',
    questionText: 'Berapa skor SEO jika halaman memuat dalam 2 detik pada skala 1-10?',
    questionType: 'slider',
    sliderMin: 1,
    sliderMax: 10,
    correctAnswer: 8,
  ...
  {
    id: 'wd7',
    questionText: 'Analisis kode berikut dan temukan kesalahan: `<img src="photo.jpg">` di HTML5.',
    questionType: 'short_answer',
    correctAnswer: 'tag img butuh alt',
    points: ,
    timeLimit: 50,
    order: 7,
  },
  {
    id: 'wd8',
    questionText: 'Manakah metode HTTP yang biasanya digunakan untuk mengirim data formulir?',
    questionType: 'multiple_choice',
  ...
  {
    id: 'wd9',
    questionText: 'Evaluasi: Apakah penggunaan inline CSS biasanya baik untuk maintainability?',
    questionType: 'true_false',
    options: ['True', 'False'],
    correctAnswer: 'False',
    points: ,
  ...
  {
    id: 'wd10',
    questionText: 'Rancang pendekatan untuk membuat halaman web responsif menggunakan CSS.',
    questionType: 'short_answer',
    correctAnswer: 'media queries fluid layout fleksibel',
    points: ,
    timeLimit: 90,
    order: 10,
  },
